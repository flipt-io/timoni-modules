...
A [timoni.sh](http://timoni.sh) module for deploying otel-operator to Kubernetes clusters.
...
```shell
timoni -n default apply otel-operator oci://<container-registry-url>
```
...
```shell
timoni -n default delete otel-operator
```
