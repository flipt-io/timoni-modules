...
#Config: {
	...
	// Required values for svix configuration.
	connections!: {
		redisDSN: string
		dbDSN: string,
	}

	// Optional list of other environment variables that can be used.
	env: [string]: string
	...
	// By default, the HTTP port is 8071.
	service: {
		annotations?: timoniv1.#Annotations

		port: *8701 | int & >0 & <=65535
	}
