...
A [timoni.sh](http://timoni.sh) module for deploying svix-webhooks to Kubernetes clusters.
...
```shell
timoni -n default apply svix-webhooks oci://<container-registry-url>
```
...
```shell
timoni -n default delete svix-webhooks
```
